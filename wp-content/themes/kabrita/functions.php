<?php
/**
 * kabrita functions and definitions
 *
...
## ver 6
function load_csv($file_encodings = ['cp1251','UTF-8'], $col_delimiter = '', $row_delimiter = "" ){
	
global $wpdb;

	$file_path = get_home_path()  . '/promo.csv';
	...
	foreach ($data as $k => $val){
		$mylink = $wpdb->get_row( "SELECT * FROM wp_promo WHERE promo = '{$val[0]}'" );
		if ($mylink == null){
			$wpdb->insert('wp_promo', array("promo" => $val[0], "check_promo" => '0'));
		}		
	}
